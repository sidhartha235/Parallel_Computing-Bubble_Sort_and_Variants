...
int main (int argc, char** argv)
{
    ...
    printf("1. Bubble Sort (only 1 thread is used)\n");
    printf("2. Odd-Even Transposition Sort (only 1 thread is used)\n");
    printf("3. Parallel Odd-Even Transposition Sort\n");
    printf("4. Shell Sort (only 1 thread is used)\n");
